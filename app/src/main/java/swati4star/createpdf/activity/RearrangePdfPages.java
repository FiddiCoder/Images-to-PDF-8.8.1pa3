...
public class RearrangePdfPages extends AppCompatActivity implements RearrangePdfAdapter.OnClickListener {
    ...
    protected RearrangePdfAdapter mRearrangeImagesAdapter;
    protected SharedPreferences mSharedPreferences;
    protected ArrayList<Integer> mSequence;
    protected ArrayList<Integer> mInitialSequence;
    ...
    protected void initRecyclerView(ArrayList<Bitmap> images) {
