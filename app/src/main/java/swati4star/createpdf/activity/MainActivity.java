...
public class MainActivity extends AppCompatActivity
    ...
    protected FragmentManagement mFragmentManagement;
     ...
     */
    protected void openWelcomeActivity() {
     ...
     */
    protected void handleReceivedImagesIntent(Fragment fragment) {
     ...
     */
    protected void setTitleFragment(int title) {
        if (title != 0)
            setTitle(title);
    }
}
