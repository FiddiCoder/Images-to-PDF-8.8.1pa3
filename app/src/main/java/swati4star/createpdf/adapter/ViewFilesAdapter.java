...
public class ViewFilesAdapter extends RecyclerView.Adapter<ViewFilesAdapter.ViewFilesHolder>
    ...
    protected ArrayList<Integer> mSelectedFiles;
    protected FileUtils mFileUtils;
    protected PDFUtils mPDFUtils;
    protected PDFRotationUtils mPDFRotationUtils;
    protected WatermarkUtils mWatermarkUtils;
    protected PDFEncryptionUtility mPDFEncryptionUtils;
    private final DatabaseHelper mDatabaseHelper;
    private final SharedPreferences mSharedPreferences;

    protected List<PDFFile> mFileList;
     ...
     */
    void performOperation(int index, int position, File file) {
        switch (index) {
            case 0: //Open
     ...
     */
    protected void deleteFile(String name, int position) {
     ...
     */
    protected void onRenameFileClick(final int position) {
        new MaterialDialog.Builder(mActivity)
