...
public class ViewFilesFragment extends Fragment
    ...
    protected ViewFilesAdapter mViewFilesAdapter;

    protected DirectoryUtils mDirectoryUtils;
    private SearchView mSearchView;
    private int mCurrentSortingIndex;
    private SharedPreferences mSharedPreferences;
    protected boolean mIsAllFilesSelected = false;
    protected boolean mIsMergeRequired = false;
    private AlertDialog.Builder mAlertDialogBuilder;

    private int mCountFiles = 0;
    protected MergeHelper mMergeHelper;
     ...
     */
    protected void checkIfListEmpty() {
        onRefresh();
    ...
    protected void displaySortDialog() {
