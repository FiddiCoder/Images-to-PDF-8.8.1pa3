...
public class AddImagesFragment extends Fragment implements BottomSheetPopulate,
    ...
    protected MorphButtonUtility mMorphButtonUtility;
    ...
    protected static final int REQUEST_PERMISSIONS_CODE = 124;
    protected static ArrayList<String> mImagesUri = new ArrayList<>();
