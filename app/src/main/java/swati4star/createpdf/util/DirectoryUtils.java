...
public class DirectoryUtils {
     ...
     */
    protected int checkChar(String query, String fileName) {
    ...
    protected ArrayList<File> searchPdfsFromPdfFolder(File[] files) {
     ...
     */
    protected boolean isPDFAndNotDirectory(File file) {
