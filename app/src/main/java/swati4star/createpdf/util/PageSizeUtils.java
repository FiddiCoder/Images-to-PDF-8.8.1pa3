...
public class PageSizeUtils {
    ...
    protected HashMap<Integer, Integer> mPageSizeToString;
     ...
     */
    protected String getPageSize(int selectionId, String spinnerAValue, String spinnerBValue) {
     ...
     * @return - key value
     */
    protected Integer getKey(HashMap<Integer, Integer> map, String value) {
