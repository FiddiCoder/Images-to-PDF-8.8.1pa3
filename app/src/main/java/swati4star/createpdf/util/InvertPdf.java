...
public class InvertPdf extends AsyncTask<Void, Void, Void> {
     ...
     */
    protected boolean createPDF(String mPath, String outputPath) {
     ...
     */
    protected void invert(PdfStamper stamper) {
     ...
     */
    protected void invertPage(PdfStamper stamper, int page) {
